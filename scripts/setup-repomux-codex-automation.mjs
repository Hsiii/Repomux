...
async function main() {
    ...
    process.stdout.write(
        [
            ...
            '',
            'Preferred setup:',
            '1. From any Codex chat, ask Codex to set up the codex-ready GitHub automation directly.',
            '2. No Repomux checkout is required for that native setup.',
            '3. Let Codex create a suggested automation in the app for review.',
            '4. Confirm the local repository root and GitHub search scope before saving if they are not already known.',
            '5. Make sure GitHub is connected in Codex and local git or gh auth is ready if the run needs clone or push access.',
            '',
            'Manual fallback:',
